...
- 🔭 Actualmente desarrollando un ecosistema completo: una **API REST (Laravel/MySQL)** que alimenta un cliente web (**HTML/CSS/JS**) y futuras apps nativas en **Android (Kotlin)** e **iOS (Swift)**.
